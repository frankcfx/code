package com.ibeifeng.senior.kafka.producer;
...
//        props.put("partitioner.class", "com.ibeifeng.senior.kafka.producer.PartitionerDemo");
        ...
        for (int i = 0; i < 3; i++) {
            new Thread(new Runnable() {
                ...
                public void run() {
                    // 初始化一个发送数据条数的值
                    int events = random.nextInt(10000) + 1000;
